...
import { Home, Dashboard, Exchanges, News, Portfolio, Profile, AboutUs, Login, Signup, ForgotPassword, AccountSettings } from '../pages'
...
export default function AppRoutes(props) {
    return (
        <Routes>
            ...
            <Route path="/dashboard" exact element={<Dashboard accessToken={props.accessToken}/>} />
            <Route path="/news" exact element={<News />} />
            <Route path="/exchanges" exact element={<Exchanges />} />
            <Route path="/profile" exact element={<Profile accessToken={props.accessToken}/>} />
            <Route path="/crypto/:name" exact element={<SpecificCrypto accessToken={props.accessToken}/>} />
            ...
            <Route path="/accountsettings" exact element={<AccountSettings />} />
        </Routes>
    )
}