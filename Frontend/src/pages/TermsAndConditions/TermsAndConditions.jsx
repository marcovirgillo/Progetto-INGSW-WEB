...
export default function TermsAndConditions() {
    ...
    return (
        <div className='terms-conditions'>
            ...
            <div className='paper-grey-terms-conditions'>
                ...
                <div align="center" style={{ textAlign: "left", lineHeight: 1 }}>
                            ...
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                                <span style={{ fontSize: 15 }}>
                                    <a data-custom-class="link" href="#law">
                                        <span style={{ color: "rgb(89, 89, 89)" }}>15. GOVERNING LAW</span>
                                    </a>
                                </span>
                            </div>
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                            ...
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                                <span style={{ fontSize: 15 }}>
                                    <a data-custom-class="link" href="#disclaimer">
                                        <span style={{ color: "rgb(89, 89, 89)" }}>18. DISCLAIMER</span>
                                    </a>
                                </span>
                            </div>
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                            ...
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                                <span style={{ fontSize: 15 }}>
                                    <a data-custom-class="link" href="#userdata">
                                        <span style={{ color: "rgb(89, 89, 89)" }}>21. USER DATA</span>
                                    </a>
                                </span>
                            </div>
                            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                    ...
                    >
                        ...
                        >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <bdt className="question">Italy</bdt>
                                                <bdt className="statement-end-if-in-editor">
                                                    <span
                                                        style={{
                                                            fontSize: "11.0pt",
                                        ...
                                        <bdt className="question">Via Giulio Cesare 2, Arcavacata</bdt>
                                        <bdt className="block-component" />
                                    </span>
                                </span>
                                , <bdt className="question">Rende</bdt>
                            </span>
                            <span style={{ fontSize: 15 }}>
                                <span data-custom-class="body_text">
                                    <span style={{ fontSize: 15 }}>
                                        <span data-custom-class="body_text">
                                            <span style={{ color: "rgb(89, 89, 89)" }}>
                                                <bdt className="block-component" />,{" "}
                                                <bdt className="question">Cosenza</bdt>
                                                <bdt className="statement-end-if-in-editor" />
                                                <bdt className="block-component" />
                                                <bdt className="question">87036</bdt>
                                                <bdt className="statement-end-if-in-editor" />
                                            </span>
                                        </span>
                                    </span>
                            ...
                            you have read, understood, and agreed to be bound by all of these Terms of
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                or modifications to these Terms of Use{" "}
                                <bdt className="block-component" />
                                at any time and for any reason
                                <bdt className="statement-end-if-in-editor" />. We will alert you about
                                ...
                                Site so that you understand which Terms apply. You will be subject to,
                    ...
                    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
                        ...
                        <div align="center" style={{ textAlign: "left" }}>
                            ...
                            >
                                ...
                                . <bdt className="question">CryptoView</bdt> and yourself irrevocably
                    ...
                    <div align="center" style={{ textAlign: "left" }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <span style={{ fontSize: "14.6667px" }}>3</span>) breach of these Terms
                                of Use; (<span style={{ fontSize: "14.6667px" }}>4</span>) any breach of
                                    ...
                                    <strong>
                                        <span style={{ fontSize: 15 }}>
                                            <bdt className="question">
                                                ...
                                                Via Giulio Cesare 2, Arcavacata
                                            </bdt>
                                            <bdt className="statement-end-if-in-editor" />
                                        </span>
                                    </strong>
                                        ...
                                        >
                                            ...
                                            >
                                                <bdt
                                                    ...
                                                    data-type="question"
                                                >
                                                    <strong>cryptoview.dev@gmail.com</strong>
                                                </bdt>
                                            </span>
                                        </div>
                                    </strong>
